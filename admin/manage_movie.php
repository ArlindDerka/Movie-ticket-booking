	...
	<div class="col-lg-12">
		<form id="manage-movie">
			<div class="form-group">
				...
				<label for="" class="control-label">titulli Shfaqjes</label>
				<input type="text" name="title" required="" class="form-control" value="<?php echo isset($meta['title']) ? $meta['title'] : '' ?>">
			</div>
			<div class="form-group">
				<label for="" class="control-label">Pershkimi</label>
			...
			<div class="form-group row">
				<label for="" class="control-label col-md-12">Kohezgjatja</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Skeduli Shfaqjes</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Data Perfundimit</label>
			...
			<div class="form-group input-group">
				<label for="" class="control-label">Imazhi</label>
				<br>
				<div class="input-group-prepend">
				    <span class="input-group-text">Ngarko</span>
				  </div>
				  <div class="custom-file">
				    <input type="file" name="cover" class="custom-file-input" id="cover-img" onchange="displayImg(this,$(this))">
				    <label class="custom-file-label" for="cover-img">Zgjidh File</label>
				  </div>
			</div>
	...
	$('#manage-movie').submit(function(e){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1){
					alert_toast('Te dhenat u regjistruan me sukses.','success')
					setTimeout(function(){
						location.reload()
					},1500)
					// end_load()
