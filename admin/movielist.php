...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-12">
			<button class="btn btn-block btn-sm btn-primary col-sm-2" type="button" id="new_movie"><i class="fa fa-plus"></i> Shfaqje Re</button>
		</div>
	</div>
	<div class="row">
				...
				<table class="table table-bordered">
					<thead>
						<tr>
							...
							<th class="text-center">Titulli</th>
						...
						while($row=$movie->fetch_assoc()){
						 ...
						 <tr>
						 	...
						 	<td>
						 		<center>
								<div class="btn-group">
								  <button type="button" class="btn btn-primary">Veprimi</button>
								  <button type="button" class="btn btn-primary dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								    <span class="sr-only">Toggle Dropdown</span>
								  </button>
								  <div class="dropdown-menu">
								    <a class="dropdown-item edit_movie" href="javascript:void(0)" data-id = '<?php echo $row['id'] ?>'>Modifiko</a>
								    <div class="dropdown-divider"></div>
								    <a class="dropdown-item delete_movie" href="javascript:void(0)" data-id = '<?php echo $row['id'] ?>'>Fshi</a>
								  </div>
								</div>
								</center>
						 	</td>
