...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-12">
			<button class="btn btn-block btn-sm btn-primary col-sm-2" type="button" id="new_theater"><i class="fa fa-plus"></i> Teater Ri</button>
			<button class="btn btn-block btn-sm btn-primary col-sm-2" type="button" id="new_group"><i class="fa fa-plus"></i> Grup Vendesh </button>
		</div>
	</div>
	<div class="row">
						...
						while($row=$theater->fetch_assoc()){
						 ...
						 <tr>
						 	...
						 	<td>
						 		<center>
								<div class="btn-group">
								  <button type="button" class="btn btn-primary btn-sm">Veprimi</button>
								  <button type="button" class="btn btn-primary btn-sm dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								    <span class="sr-only">Toggle Dropdown</span>
								  </button>
								  <div class="dropdown-menu">
								    <a class="dropdown-item edit_theater" href="javascript:void(0)" data-id = '<?php echo $row['id'] ?>'>Modifiko</a>
								    <div class="dropdown-divider"></div>
								    <a class="dropdown-item delete_theater" href="javascript:void(0)" data-id = '<?php echo $row['id'] ?>'>Fshi</a>
								  </div>
								</div>
								</center>
						 	</td>
				...
				<table class="table table-bordered">
					<thead>
						<tr>
							...
							<th class="text-center">Grupi</th>
							<th class="text-center">Vendet</th>
						...
						while($row=$theater->fetch_assoc()){
						 ...
						 <tr>
						 	...
						 	<td>
						 		<center>
								<div class="btn-group">
								  <button type="button" class="btn btn-primary btn-sm">Veprim</button>
								  <button type="button" class="btn btn-primary btn-sm dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								    <span class="sr-only">Toggle Dropdown</span>
								  </button>
								  <div class="dropdown-menu">
								    <a class="dropdown-item edit_seat" href="javascript:void(0)" data-id = '<?php echo $row['id'] ?>'>Modifiko</a>
								    <div class="dropdown-divider"></div>
								    <a class="dropdown-item delete_seat" href="javascript:void(0)" data-id = '<?php echo $row['id'] ?>'>Fshi</a>
								  </div>
								</div>
								</center>
						 	</td>
